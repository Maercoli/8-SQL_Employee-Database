...
SELECT dept_manager.emp_no, deptarments.dept_no, deptarments.dept_name, employees.last_name, employees.first_name
FROM deptarments
	JOIN dept_manager
	ON deptarments.dept_no = dept_manager.dept_no
	JOIN employees
...
SELECT employees.emp_no, employees.last_name, employees.first_name, deptarments.dept_name 
FROM deptarments
	JOIN dept_manager
	ON deptarments.dept_no = dept_manager.dept_no
	JOIN employees
...
FROM deptarments
	JOIN dept_manager
	ON deptarments.dept_no = dept_manager.dept_no
		AND deptarments.dept_name IN ('Sales', 'Development')
	JOIN employees
	ON dept_manager.emp_no = employees.emp_no;
